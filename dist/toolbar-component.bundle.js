...
!function(f){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=f();else if("function"==typeof define&&define.amd)define([],f);else{var g;g="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,g.toolbarComponent=f()}}(function(){return function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof require&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof require&&require,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(require,module,exports){var IIIFComponents,__extends=this&&this.__extends||function(d,b){function __(){this.constructor=d}for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p]);d.prototype=null===b?Object.create(b):(__.prototype=b.prototype,new __)};!function(IIIFComponents){var ToolbarComponent=function(_super){function ToolbarComponent(options){var default_opts={orientation:"vertical"};options=$.extend(default_opts,options),_super.call(this,options),this._init(),this._resize()}return __extends(ToolbarComponent,_super),ToolbarComponent.prototype.test=function(){this._emit(ToolbarComponent.Events.TEST,[1,2,"three"])},ToolbarComponent.prototype._init=function(){var success=_super.prototype._init.call(this);return success||console.error("Component failed to initialise"),this._$element.append("I am a toolbar that is:"+this.options.orientation),success},ToolbarComponent.prototype._getDefaultOptions=function(){return{}},ToolbarComponent.prototype._resize=function(){},ToolbarComponent}(_Components.BaseComponent);IIIFComponents.ToolbarComponent=ToolbarComponent}(IIIFComponents||(IIIFComponents={}));var IIIFComponents;!function(IIIFComponents){var ToolbarComponent;!function(ToolbarComponent){var Events=function(){function Events(){}return Events.TEST="test",Events}();ToolbarComponent.Events=Events}(ToolbarComponent=IIIFComponents.ToolbarComponent||(IIIFComponents.ToolbarComponent={}))}(IIIFComponents||(IIIFComponents={})),function(w){w.IIIFComponents?w.IIIFComponents.ToolbarComponent=IIIFComponents.ToolbarComponent:w.IIIFComponents=IIIFComponents}(window)},{}]},{},[1])(1)});